  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
      ...
      <p className="text-lg text-gray-700 mb-6">
        <span className="font-semibold">Giới tính:</span> {product.gender || "Không xác định"}
      </p>
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  {variant.images && variant.images.length > 0 ? (
                    ...
                    <p className="text-gray-600 ml-4">Không có ảnh cho biến thể này.</p>
                  )}
                </div>
      ...
      <div className="mb-6 space-y-2">
        <p className="text-lg text-gray-700">
          <span className="font-semibold">Thương hiệu:</span> {product.brand || "Không xác định"}
        </p>
        <p className="text-lg text-gray-700">
