...
import { deleteBrand, getAllBrands } from "../../../../service/brand";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Danh sách thương hiệu</h1>
        <Link
          to="/admin/brands/add"
      ...
      {loading ? (
        ...
        <div className="text-center py-10">
          <p className="text-gray-600 text-lg">Không tìm thấy thương hiệu nào.</p>
          <Link
            to="/admin/brands/add"
          ...
          {brands.map((brand) => (
            ...
            >
              ...
              <div className="mt-4 text-center">
                <h3 className="text-gray-800 text-lg font-semibold truncate">{brand.name}</h3>
